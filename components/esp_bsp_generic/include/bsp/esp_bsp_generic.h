...
#define BSP_LED_6_IO        (CONFIG_BSP_LED_6_GPIO)
...
#define BSP_LITTLEFS_MOUNT_POINT    CONFIG_BSP_LITTLEFS_MOUNT_POINT

/**
 * @brief Mount LittleFS to virtual file system
 *
 * @return
 *      - ESP_OK on success
...
/**
 * @brief Unmount LittleFS from virtual file system
 *
 * @return
 *      - ESP_OK on success
 *      - ESP_ERR_NOT_FOUND if the partition table does not contain LittleFS partition with given label
