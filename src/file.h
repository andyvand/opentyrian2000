...
static inline void fread_bool_die(bool *buffer, SceUID stream)
{
    Uint8 temp;
...
// 8-bit fread
static inline size_t fread_u8(Uint8 *buffer, size_t count, SceUID stream)
{
    return sceIoRead(stream, buffer, sizeof(Uint8) * count);
}

// 8-bit fread that dies if read fails
static inline void fread_u8_die(Uint8 *buffer, size_t count, SceUID stream)
{
    fread_die(buffer, sizeof(Uint8), count, stream);
}

// 8-bit fread that dies if read fails
static inline void fread_s8_die(Sint8 *buffer, size_t count, SceUID stream)
{
    fread_die(buffer, sizeof(Sint8), count, stream);
}

// 16-bit endian-swapping fread that dies if read fails
static inline void fread_u16_die(Uint16 *buffer, size_t count, SceUID stream)
{
...
// 16-bit endian-swapping fread that dies if read fails
static inline void fread_s16_die(Sint16 *buffer, size_t count, SceUID stream)
{
...
static inline void fread_u32_die(Uint32 *buffer, size_t count, SceUID stream)
{
...
// 32-bit endian-swapping fread that dies if read fails
static inline void fread_s32_die(Sint32 *buffer, size_t count, SceUID stream)
{
...
static inline void fwrite_bool_die(const bool *buffer, SceUID stream)
{
...
// 8-bit fwrite
static inline size_t fwrite_u8(const Uint8 *buffer, size_t count, SceUID stream)
{
    return sceIoWrite(stream, buffer, sizeof(Uint8) * count);
}

// 8-bit fwrite that dies if write fails
static inline void fwrite_u8_die(const Uint8 *buffer, size_t count, SceUID stream)
{
    fwrite_die(buffer, sizeof(Uint8), count, stream);
}

// 8-bit fwrite that dies if write fails
static inline void fwrite_s8_die(const Sint8 *buffer, size_t count, SceUID stream)
{
    fwrite_die(buffer, sizeof(Sint8), count, stream);
}

// 16-bit endian-swapping fwrite that dies if write fails
static inline void fwrite_u16_die(const Uint16 *buffer, SceUID stream)
{
#if SDL_BYTEORDER == SDL_BIG_ENDIAN
...
// 16-bit endian-swapping fwrite that dies if write fails
static inline void fwrite_s16_die(const Sint16 *buffer, SceUID stream)
{
#if SDL_BYTEORDER == SDL_BIG_ENDIAN
...
static inline void fwrite_u32_die(const Uint32 *buffer, SceUID stream)
{
#if SDL_BYTEORDER == SDL_BIG_ENDIAN
...
// 32-bit endian-swapping fwrite that dies if write fails
static inline void fwrite_s32_die(const Sint32 *buffer, SceUID stream)
{
#if SDL_BYTEORDER == SDL_BIG_ENDIAN
