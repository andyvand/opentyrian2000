...
#if defined(TARGET_GP2X) || defined(TARGET_DINGUX) || defined(APPLETV) || defined(PSP) || defined(__PS2__) || defined(VITA) || defined(__SWITCH__) || defined(__3DS__) || (defined(WITH_SDL) && !CONFIG_TOUCH_ENABLED && !defined(WITH_SDL1))
