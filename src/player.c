...
void OTATTR calc_purple_balls_needed(Player *this_player)
{
...
bool OTATTR power_up_weapon(Player *this_player, uint port)
{
...
void OTATTR handle_got_purple_ball(Player *this_player)
{
